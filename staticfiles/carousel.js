...
// Enhanced carousel for landing page templates
class LandingTemplateCarousel {
    constructor() {
        this.track = document.getElementById('templateTrack');
        this.slides = document.querySelectorAll('.template-slide');
        this.prevBtn = document.getElementById('templatePrevBtn');
        this.nextBtn = document.getElementById('templateNextBtn');
        this.currentIndex = 1; // Start with middle template
        this.isAnimating = false;
...
document.addEventListener('DOMContentLoaded', () => {
    // Initialize main carousel if exists
    if (document.querySelector('.templates-carousel')) {
    ...
    // Initialize landing page template carousel if exists
    if (document.getElementById('templateTrack')) {
        const landingCarousel = new LandingTemplateCarousel();
        window.landingCarousel = landingCarousel;
    }
});
